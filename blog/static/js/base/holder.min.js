...
!function (t) {
    if (t.document) {
        ...
        e.querySelectorAll || (e.querySelectorAll = function (r) {
            var n, i = e.createElement("style"), o = [];
    ...
    return function (t) {
        ...
        (function (e) {
            ...
            function o(t) {
                var e = t.mode, r = t.el, n = t.flags, i = t.engineSettings, o = n.dimensions, s = n.theme, l = o.width + "x" + o.height;
                e = null == e ? n.fluid ? "fluid" : "image" : e;
                var f = /holder_([a-z]+)/g, c = !1;
                ...
                var m = n.holderURL, v = T(i, null);
                if (n.font && (s.font = n.font, !v.noFontFallback && "img" === r.nodeName.toLowerCase() && U.setup.supportsCanvas && "svg" === v.renderer && (v = T(v, {renderer: "canvas"}))), n.font && "canvas" == v.renderer && (v.reRender = !0), "background" == e)null == r.getAttribute("data-background-src") && E.setAttr(r, {"data-background-src": m}); else {
                    var y = {};
                ...
                n.theme = s, r.holderData = {
                    flags: n,
                    engineSettings: v
                }, ("image" == e || "fluid" == e) && E.setAttr(r, {alt: s.text ? c ? s.text : s.text + " [" + l + "]" : l});
            ...
            function a(t) {
                ...
                var n = null, i = t.mode, o = t.el, a = t.holderSettings, l = t.engineSettings;
                switch (l.renderer) {
                    case"svg":
                ...
                "background" == i ? (o.style.backgroundImage = "url(" + n + ")", o.style.backgroundSize = h.width + "px " + h.height + "px") : ("img" === o.nodeName.toLowerCase() ? E.setAttr(o, {src: n}) : "object" === o.nodeName.toLowerCase() && E.setAttr(o, {
                    data: n,
                    type: "image/svg+xml"
                }), l.reRender && e.setTimeout(function () {
                    var t = r();
                    if (null == t)throw"Holder: couldn't render placeholder";
                    "img" === o.nodeName.toLowerCase() ? E.setAttr(o, {src: t}) : "object" === o.nodeName.toLowerCase() && E.setAttr(o, {
                        data: t,
                        type: "image/svg+xml"
                    })
                }, 150)), E.setAttr(o, {"data-holder-rendered": !0})
            }
            ...
            function s(t) {
                ...
                var n = t.flags.lineWrap || U.setup.lineWrapRatio, i = t.width * n, o = i, a = new y({
                    width: t.width,
                    height: t.height
                }), s = a.Shape, h = new s.Rect("holderBg", {fill: t.theme.bg});
                ...
                var f = t.theme.fg;
                if (t.flags.autoFg) {
                    var c = new A(h.properties.fill), d = new A("fff"), p = new A("000", {alpha: .285714});
                ...
                if (m.lineCount > 1) {
                    ...
                    if (e(g, w, E, g.properties.leading), g.add(w), "left" === t.align)g.moveTo(t.width - i, null, null); else if ("right" === t.align) {
            ...
            function l(t, e, r, n) {
                var i = parseInt(t, 10), o = parseInt(e, 10), a = Math.max(i, o), s = Math.min(i, o), l = .8 * Math.min(s, a * n);
            ...
            function h(t) {
                ...
                for (var r = 0, n = e.length; n > r; r++) {
                    var i = e[r];
                    if (i.holderData) {
                        var o = i.holderData.flags, s = B(i);
                        if (s) {
            ...
            var m = r(2), v = r(3), y = r(10), w = r(11), b = r(12), E = r(13), A = r(14), x = r(15), S = r(16), I = r(19), T = w.extend, B = w.dimensionCheck, R = x.svg_ns, C = {
                version: x.version,
                ...
                run: function (t) {
                    ...
                    var s = E.getNodeArray(a.images), l = E.getNodeArray(a.bgnodes), h = E.getNodeArray(a.stylenodes), u = E.getNodeArray(a.objects);
                    return r.stylesheets = [], r.svgXMLStylesheet = !0, r.noFontFallback = a.noFontFallback ? a.noFontFallback : !1, h.forEach(function (t) {
                        if (t.attributes.rel && t.attributes.href && "stylesheet" == t.attributes.rel.value) {
                            var e = t.attributes.href.value, n = E.newEl("a");
                            n.href = e;
                        ...
                        if (e.getComputedStyle) {
                            var n = e.getComputedStyle(t, null).getPropertyValue("background-image"), s = t.getAttribute("data-background-src"), l = s || n, h = null, u = a.domain + "/", f = l.indexOf(u);
                            if (0 === f)h = l; else if (1 === f && "?" === l[0])h = l.slice(1); else {
                        ...
                        var o = null != e.data && 0 === e.data.indexOf(a.domain), s = null != e.dataSrc && 0 === e.dataSrc.indexOf(a.domain);
                        ...
                        var o = null != e.src, s = null != e.dataSrc && 0 === e.dataSrc.indexOf(a.domain), l = null != e.rendered && "true" == e.rendered;
                ...
                return function (n) {
                    ...
                    if (U.setup.supportsSVG) {
                        ...
                        (null == t || t.parentNode !== document.body) && (o = !0), t = b.initSVG(t, i.properties.width, i.properties.height), t.style.display = "block", o && (e = E.newEl("text", R), r = a(null), E.setAttr(e, {x: 0}), e.appendChild(r), t.appendChild(e), document.body.appendChild(t), t.style.visibility = "hidden", t.style.position = "absolute", t.style.top = "-100%", t.style.left = "-100%");
                        ...
                        var h = e.getBBox(), u = Math.ceil(h.width / i.properties.width), f = l.text.split(" "), c = l.text.match(/\\n/g);
                        u += null == c ? 0 : c.length, r.nodeValue = l.text.replace(/[ ]+/g, "");
                        var d = e.getComputedTextLength(), p = h.width - d, g = Math.round(p / Math.max(1, f.length - 1)), m = [];
                        if (u > 1) {
                            r.nodeValue = "";
                            for (var v = 0; v < f.length; v++)if (0 !== f[v].length) {
        ...
        function r(t) {
            ...
            var a = t.document, s = a.documentElement, l = "load", h = !1, u = "on" + l, f = "complete", c = "readyState", d = "attachEvent", p = "detachEvent", g = "addEventListener", m = "DOMContentLoaded", v = "onreadystatechange", y = "removeEventListener", w = g in a, b = h, E = h, A = [];
            if (a[c] === f)i(e); else if (w)a[g](m, r, h), t[g](l, r, h); else {
                a[d](v, r), t[d](u, r);
                try {
        ...
        var n = encodeURIComponent, i = decodeURIComponent, o = r(4), a = r(5), s = /(\w+)\[(\d+)\]/, l = /\w+\.\w+/;
        e.parse = function (t) {
            if ("string" != typeof t)return {};
            if (t = o(t), "" === t)return {};
            "?" === t.charAt(0) && (t = t.slice(1));
            for (var e = {}, r = t.split("&"), n = 0; n < r.length; n++) {
                var a, h, u, f = r[n].split("="), c = i(f[0]);
                if (a = s.exec(c))e[a[1]] = e[a[1]] || [], e[a[1]][a[2]] = i(f[1]); else if (a = l.test(c)) {
                    for (a = c.split("."), h = e; a.length;)if (u = a.shift(), u.length) {
                        if (h[u]) {
            ...
            for (var r in t) {
                var i = t[r];
                if ("array" != a(i))e.push(n(r) + "=" + n(t[r])); else for (var o = 0; o < i.length; ++o)e.push(n(r + "[" + o + "]") + "=" + n(i[o]))
            }
            return e.join("&")
        }
    }, function (t, e) {
        ...
        (function (t, n) {
            ...
            t.TYPED_ARRAY_SUPPORT = void 0 !== n.TYPED_ARRAY_SUPPORT ? n.TYPED_ARRAY_SUPPORT : i(), t.TYPED_ARRAY_SUPPORT && (t.prototype.__proto__ = Uint8Array.prototype, t.__proto__ = Uint8Array), t.isBuffer = function (t) {
                ...
                function n(t, e, r) {
                    for (var n = -1, i = 0; r + i < t.length; i++)if (t[r + i] === e[-1 === n ? 0 : i - n]) {
                ...
                if (void 0 === e)n = "utf8", r = this.length, e = 0; else if (void 0 === r && "string" == typeof e)n = e, r = this.length, e = 0; else if (isFinite(e))e = 0 | e, isFinite(r) ? (r = 0 | r, void 0 === n && (n = "utf8")) : (n = r, r = void 0); else {
                    var i = n;
                    n = e, e = 0 | r, r = i
                }
                var o = this.length - e;
            ...
            t.prototype.slice = function (e, r) {
                ...
                var i;
                if (t.TYPED_ARRAY_SUPPORT)i = t._augment(this.subarray(e, r)); else {
                    var o = r - e;
                    i = new t(o, void 0);
                ...
                var o, a = i - n;
                if (this === e && r > n && i > r)for (o = a - 1; o >= 0; o--)e[o + r] = this[o + n]; else if (1e3 > a || !t.TYPED_ARRAY_SUPPORT)for (o = 0; a > o; o++)e[o + r] = this[o + n]; else e._set(this.subarray(n, n + a), r);
                return a
        ...
        !function (t) {
            ...
            var o = "undefined" != typeof Uint8Array ? Uint8Array : Array, a = "+".charCodeAt(0), s = "/".charCodeAt(0), l = "0".charCodeAt(0), h = "a".charCodeAt(0), u = "A".charCodeAt(0), f = "-".charCodeAt(0), c = "_".charCodeAt(0);
            t.toByteArray = r, t.fromByteArray = i
        }(e)
    }, function (t, e) {
        e.read = function (t, e, r, n, i) {
            var o, a, s = 8 * i - n - 1, l = (1 << s) - 1, h = l >> 1, u = -7, f = r ? i - 1 : 0, c = r ? -1 : 1, d = t[e + f];
            ...
            var a, s, l, h = 8 * o - i - 1, u = (1 << h) - 1, f = u >> 1, c = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = n ? 0 : o - 1, p = n ? 1 : -1, g = 0 > e || 0 === e && 0 > 1 / e ? 1 : 0;
        ...
        var r = function (t) {
            ...
            i.prototype = new n;
            var o = function (t, r) {
                if (n.call(this, t), this.properties = {fill: "#000000"}, "undefined" != typeof r)e(this.properties, r); else if ("undefined" != typeof t && "string" != typeof t)throw"SceneGraph: invalid node name"
            };
            o.prototype = new n;
            var a = function () {
        ...
        (function (t) {
            e.extend = function (t, e) {
                ...
                return "string" == typeof t ? "true" === t || "yes" === t || "1" === t || "on" === t || "鉁�" === t : !!t
            }, e.parseColor = function (t) {
                var e, r = /(^(?:#?)[0-9a-f]{6}$)|(^(?:#?)[0-9a-f]{3}$)/i, n = /^rgb\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)$/, i = /^rgba\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(0\.\d{1,}|1)\)$/, o = t.match(r);
        ...
        (function (t) {
            var n = r(13), i = "http://www.w3.org/2000/svg", o = 8;
            e.initSVG = function (t, e, r) {
                var a, s, l = !1;
                t && t.querySelector ? (s = t.querySelector("style"), null === s && (l = !0)) : (t = n.newEl("svg", i), l = !0), l && (a = n.newEl("defs", i), s = n.newEl("style", i), n.setAttr(s, {type: "text/css"}), a.appendChild(s), t.appendChild(a)), t.webkitMatchesSelector && t.setAttribute("xmlns", i);
                ...
                var e = "data:image/svg+xml;charset=UTF-8,", r = "data:image/svg+xml;charset=UTF-8;base64,";
                return function (n, i) {
                    return i ? r + btoa(t.unescape(encodeURIComponent(n))) : e + encodeURIComponent(n)
                }
            }(), e.serializeSVG = function (e, r) {
                if (t.XMLSerializer) {
                    var i = new XMLSerializer, o = "", a = r.stylesheets;
        ...
        r.rgb2hex = function (t, e, r) {
            ...
            var n = t / 60, i = (1 - Math.abs(2 * r - 1)) * e, o = i * (1 - Math.abs(parseInt(n) % 2 - 1)), a = r - i / 2, s = 0, l = 0, h = 0;
            ...
            this.raw = t;
            var e = (16711680 & this.raw) >> 16, r = (65280 & this.raw) >> 8, n = 255 & this.raw, i = .2126 * e + .7152 * r + .0722 * n, o = -.09991 * e - .33609 * r + .436 * n, a = .615 * e - .55861 * r - .05639 * n;
            return this.rgb = {r: e, g: r, b: n}, this.yuv = {y: i, u: o, v: a}, this
        }, r.prototype.lighten = function (t) {
            var e = Math.min(1, Math.max(0, Math.abs(t))) * (0 > t ? -1 : 1), n = 255 * e | 0, i = Math.min(255, Math.max(0, this.rgb.r + n)), o = Math.min(255, Math.max(0, this.rgb.g + n)), a = Math.min(255, Math.max(0, this.rgb.b + n)), s = r.rgb2hex(i, o, a);
            return new r(s)
            ...
            var e = t, n = this, i = e.alpha * e.rgb.r + (1 - e.alpha) * n.rgb.r, o = e.alpha * e.rgb.g + (1 - e.alpha) * n.rgb.g, a = e.alpha * e.rgb.b + (1 - e.alpha) * n.rgb.b;
            return new r(r.rgb2hex(i, o, a))
        }, t.exports = r
    }, function (t, e) {
        t.exports = {version: "2.9.2", svg_ns: "http://www.w3.org/2000/svg"}
    }, function (t, e, r) {
        function n(t, e) {
        ...
        var a = r(17), s = r(12), l = r(15), h = r(11), u = l.svg_ns, f = {
            element: function (t) {
                var e = t.tag, r = t.content || "";
                return delete t.tag, delete t.content, [e, r, t]
            }
        };
        t.exports = function (t, e) {
            var r = e.engineSettings, l = r.stylesheets, h = l.map(function (t) {
                return '<?xml-stylesheet rel="stylesheet" href="' + t + '"?>'
            }).join("\n"), c = "holder_" + Number(new Date).toString(16), d = t.root, p = d.children.holderTextGroup, g = "#" + c + " text { " + i(p.properties) + " } ";
            ...
            Object.keys(p.children).forEach(function (t) {
                ...
                Object.keys(e.children).forEach(function (t) {
                    var r = e.children[t], n = p.x + e.x + r.x, i = p.y + e.y + r.y, o = f.element({
                        tag: "text",
            ...
            var v = f.element({tag: "g", content: m}), y = null;
            ...
            var b = n(d.children.holderBg, "rect"), E = [];
            E.push(b), w && E.push(y), E.push(v);
            var A = f.element({tag: "g", id: c, content: E}), x = f.element({
                tag: "style",
                content: g,
                type: "text/css"
            }), S = f.element({tag: "defs", content: x}), I = f.element({
                tag: "svg",
                content: [S, A],
        ...
        t.exports = function n(t, e, r) {
            ...
            function i(t) {
                var e = t.match(/^[\w-]+/), n = {
                    ...
                    attr: {},
                    children: []
                }, i = t.match(/#([\w-]+)/), o = t.match(/\$([\w-]+)/), a = t.match(/\.[\w-]+/g);
            ...
            var l, h, u, f, c = 1, d = !0;
            if (r = r || {}, "string" == typeof t[0])t[0] = i(t[0]); else {
            ...
            for (; c < t.length; c++) {
                ...
                if (void 0 !== t[c] && t[c] !== !0)if ("string" == typeof t[c])d && (t[c] = s(t[c])), t[0].children.push(t[c]); else if ("number" == typeof t[c])t[0].children.push(t[c]); else if (Array.isArray(t[c])) {
                ...
                } else if ("function" == typeof t[c])u = t[c]; else {
        ...
        var n = r(13), i = r(11);
        t.exports = function () {
            var t = n.newEl("canvas"), e = null;
            return function (r) {
                null == e && (e = t.getContext("2d"));
                var n = i.canvasRatio(), o = r.root;
                t.width = n * o.properties.width, t.height = n * o.properties.height, e.textBaseline = "middle";
                var a = o.children.holderBg, s = n * a.width, l = n * a.height, h = 2, u = h / 2;
                ...
                for (var c in f.children) {
                    ...
                    for (var p in d.children) {
                        var g = d.children[p], m = n * (f.x + d.x + g.x), v = n * (f.y + d.y + g.y + f.properties.leading / 2);
