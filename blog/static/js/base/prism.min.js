...
Prism.languages.insertBefore("groovy", "punctuation", {"spock-block": /\b(setup|given|when|then|and|cleanup|expect|where):/g});
Prism.languages.insertBefore("groovy", "function", {annotation: {pattern: /(^|[^.])@\w+/, lookbehind: !0}});
Prism.hooks.add("wrap", function (e) {
...
Prism.languages.http = {
    "request-line": {
        ...
        inside: {property: /^\b(POST|GET|PUT|DELETE|OPTIONS|PATCH|TRACE|CONNECT)\b/g, "attr-name": /:\w+/g}
    },
    "response-status": {pattern: /^HTTP\/1.[01] [0-9]+.*/g, inside: {property: /[0-9]+[A-Z\s-]+$/g}},
    keyword: /^[\w-]+:(?=.+)/gm
};
var httpLanguages = {
...
Prism.languages.aspnet = Prism.languages.extend("markup", {
    ...
    "directive tag": {
        pattern: /(<|&lt;)%.*%>/gi,
        inside: {"directive tag": /(<|&lt;)%\s*?[$=%#:]{0,2}|%>/gi, rest: Prism.languages.csharp}
    }
});
...
Prism.languages.insertBefore("aspnet", "comment", {"asp comment": /&lt;%--[\w\W]*?--%>/g});
...
(function () {
    ...
    function highlightLines(a, b, c) {
        var d = b.replace(/\s+/g, '').split(','), offset = +a.getAttribute('data-line-offset') || 0;
    ...
    function applyHash() {
        ...
        var d = b.slice(0, b.lastIndexOf('.')), pre = document.getElementById(d);
        if (!pre) {
            return
        }
...
(function () {
    ...
    if (Prism.languages.css) {
        ...
        } else Prism.languages.css.selector = {
    ...
    Prism.hooks.add("wrap", function (e) {
        if ((["tag-id"].indexOf(e.type) > -1 || e.type == "property" && e.content.indexOf("-") != 0 || e.type == "atrule-id" && e.content.indexOf("@-") != 0 || e.type == "pseudo-class" && e.content.indexOf(":-") != 0 || e.type == "pseudo-element" && e.content.indexOf("::-") != 0 || e.type == "attr-name" && e.content.indexOf("data-") != 0) && e.content.indexOf("<") === -1) {
            ...
            } else if (e.language == "markup")if (e.type == "tag-id") {
                t = n(e.content) || t;
                t ? i += "wiki/" + t + "/elements/" : i += r
            } else e.type == "attr-name" && (t ? i += "wiki/" + t + "/attributes/" : i += r);
            i += e.content;
            e.attributes.href = i;
...
(function () {
    ...
    var a = {"js": "javascript", "html": "markup", "svg": "markup", "xml": "markup", "py": "python"};
